<template>
  <div class="flex flex-col items-center mx-auto">
    <img src="/images/logo.svg" alt="DAP Aero Logo" class="w-64">

    <h1 class="font-bold text-2xl mt-1.5">
      Welcome to Dharma Angkasa Putra
    </h1>
  </div>

  <div class="grid lg:grid-cols-3 gap-y-4 gap-x-5 mt-4 w-full md:grid-cols-1">
    <div class="grid-item">
      <h2>Purchasing</h2>
    ...
    <div class="grid-item">
      <h2>Repair & Overhaul Management</h2>
...
.grid-item {
  h2 {
    @apply text-emerald-600 text-lg font-bold;
  }
}
</style>
